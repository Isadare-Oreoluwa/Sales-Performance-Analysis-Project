...
Browse the repository to explore the datasets, SQL scripts, Excel workbook, Power BI dashboard, and report. You can view files directly on GitHub or download them for offline use.
